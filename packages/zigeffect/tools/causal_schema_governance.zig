...
const schema_entries: []const SchemaEntry = &.{
    ...
    .{
        ...
        .category = "app-runtime",
        .status = "current",
        .emitted_by = &.{"causal-app-facing-thirteen-level-policy"},
        .consumed_by = &.{ "agents", "reviewers", "non-blocking CI advisory readers", "local SolidJS workbench", "production-hardening backlog", "future app-facing thirteen-level evaluator" },
        .compatibility = &.{ "strict-v1", "record-only", "policy-only", "source-thirteen-level-application-boundary", "approve-reject-decision", "local-publication-only", "read-only-consumption", "bounded-agent-context", "app-facing", "solid-webui", "webui-dev/zig-webui", "no-cockroach", "no-ci-enforcement", "no-required-status-check", "no-workflow-mutation", "no-github-api-mutation", "no-app-mutation", "no-app-runtime-integration", "no-live-agent-projection", "no-raw-payload-capture", "no-deployment-mutation", "no-production-mutation", "no-nendb-write", "no-nendb-adapter-execution", "no-public-artifact-upload", "no-hosted-live-dashboard", "no-auto-apply", "no-mutation-authority" },
        .governance_requirements = &.{ "thirteen-level policy producer tests", "applied source thirteen-level application-boundary checks", "source thirteen-level report evidence checks", "source twelve-level evaluator policy application and report lineage checks", "source eleven-level policy application and report lineage checks", "source ten-level policy application and report lineage checks", "source nine-level policy application and report lineage checks", "approve reject decision tests", "interpretation rule tests", "consumption scope tests", "negative fixture tests", "denied inference rule tests", "verification command evidence", "short alias branch and build step", "next-branch thirteen-level evaluator handoff", "docs update" },
    },
    .{
        ...
        .category = "app-runtime",
        .status = "current",
        .emitted_by = &.{"causal-app-facing-thirteen-level-evaluator"},
        .consumed_by = &.{ "agents", "reviewers", "non-blocking CI advisory readers", "local SolidJS workbench", "production-hardening backlog", "future app-facing fourteen-level report" },
        .compatibility = &.{ "strict-v1", "record-only", "advisory-only", "source-thirteen-level-policy", "bounded-explicit-evidence", "local-report-only", "read-only-consumption", "bounded-agent-context", "app-facing", "solid-webui", "webui-dev/zig-webui", "no-cockroach", "no-ci-enforcement", "no-required-status-check", "no-workflow-mutation", "no-github-api-mutation", "no-app-mutation", "no-app-runtime-integration", "no-live-agent-projection", "no-raw-payload-capture", "no-deployment-mutation", "no-production-mutation", "no-nendb-write", "no-nendb-adapter-execution", "no-public-artifact-upload", "no-hosted-live-dashboard", "no-auto-apply", "no-mutation-authority" },
        .governance_requirements = &.{ "thirteen-level evaluator producer tests", "source thirteen-level policy artifact checks", "ready advisory and blocked source policy checks", "bounded request evidence checks", "support evidence advisory checks", "redaction posture checks", "source thirteen-level report evidence carryover", "source twelve-level evaluator and policy lineage carryover", "source eleven-level lineage carryover", "source ten-level lineage carryover", "source nine-level lineage carryover", "verification command evidence", "short alias branch and build step", "next-branch fourteen-level report handoff", "docs update" },
    },
    .{
        ...
        .category = "app-runtime",
        .status = "current",
        .emitted_by = &.{"causal-app-facing-fourteen-level-report"},
        .consumed_by = &.{ "agents", "reviewers", "non-blocking CI advisory readers", "local SolidJS workbench", "production-hardening backlog", "future app-facing fourteen-level application-boundary" },
        .compatibility = &.{ "strict-v1", "record-only", "advisory-only", "source-thirteen-level-evaluator", "local-report-only", "read-only-consumption", "bounded-agent-context", "app-facing", "solid-webui", "webui-dev/zig-webui", "no-cockroach", "no-ci-enforcement", "no-required-status-check", "no-workflow-mutation", "no-github-api-mutation", "no-app-mutation", "no-app-runtime-integration", "no-live-agent-projection", "no-raw-payload-capture", "no-deployment-mutation", "no-production-mutation", "no-nendb-write", "no-nendb-adapter-execution", "no-public-artifact-upload", "no-hosted-live-dashboard", "no-auto-apply", "no-mutation-authority" },
        .governance_requirements = &.{ "fourteen-level report producer tests", "ready advisory and blocked source thirteen-level evaluator checks", "source thirteen-level policy evidence carryover", "source thirteen-level application evidence carryover", "source twelve-level evaluator and policy lineage carryover", "source eleven-level lineage carryover", "source ten-level lineage carryover", "source nine-level lineage carryover", "request and evidence summary carryover", "denied authority tests", "local publication posture tests", "verification command evidence", "short alias branch and build step", "next-branch fourteen-level application-boundary handoff", "docs update" },
    },
    .{
        ...
        .category = "app-runtime",
        .status = "current",
        .emitted_by = &.{"causal-app-facing-fourteen-level-application-boundary"},
        .consumed_by = &.{ "agents", "reviewers", "non-blocking CI advisory readers", "local SolidJS workbench", "production-hardening backlog", "future app-facing fourteen-level policy" },
        .compatibility = &.{ "strict-v1", "record-only", "advisory-only", "application-boundary", "source-fourteen-level-report", "guarded-record-applied", "local-report-only", "read-only-consumption", "bounded-agent-context", "app-facing", "solid-webui", "webui-dev/zig-webui", "no-cockroach", "no-ci-enforcement", "no-required-status-check", "no-workflow-mutation", "no-github-api-mutation", "no-app-mutation", "no-app-runtime-integration", "no-live-agent-projection", "no-raw-payload-capture", "no-deployment-mutation", "no-production-mutation", "no-nendb-write", "no-nendb-adapter-execution", "no-public-artifact-upload", "no-hosted-live-dashboard", "no-auto-apply", "no-mutation-authority" },
        .governance_requirements = &.{ "fourteen-level application-boundary producer tests", "ready advisory and blocked source report checks", "plan mode tests", "record-applied before/after evidence tests", "source fourteen-level report evidence carryover", "source thirteen-level evaluator policy application and report lineage checks", "source twelve-level evaluator policy application and report lineage checks", "source eleven-level lineage carryover", "source ten-level lineage carryover", "source nine-level lineage carryover", "after-report safety tests", "authority drift tests", "local publication channel tests", "verification command evidence", "short alias branch and build step", "next-branch fourteen-level policy handoff", "docs update" },
    },
    .{
...
test "schema governance inventory includes official schemas and excludes fake fixtures" {
    ...
    try std.testing.expectEqual(@as(usize, 155), entries.len);
...
test "schema governance text report includes policy and representative schemas" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, report, "schema count: 155") != null);
...
test "schema governance json report is machine readable" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, report, "\"schema_count\": 155") != null);
