...
const backlog_items: []const BacklogItem = &.{
    ...
    .{
        .id = "app-facing-thirteen-level-application-boundary",
        .title = "App-Facing Thirteen-Level Application Boundary",
        .gap_id = "app-facing-thirteen-level-application-boundary",
        .priority = "P1",
        .status = "delivered",
        .summary = "Consumes ready or advisory thirteen-level report evidence, records planned or reviewed local application-boundary evidence, preserves thirteen-level report plus twelve-level, eleven-level, ten-level, and nine-level lineage, and prepares the thirteen-level policy branch without mutation authority.",
        .depends_on = &.{"app-facing-thirteen-level-report"},
        .deliverables = &.{
            "thirteen-level application-boundary schema",
            "short alias build step",
            "plan applied and blocked application-boundary artifacts",
            "source thirteen-level report gates",
            "source twelve-level evaluator policy application and report carryover",
            "source eleven-level lineage carryover",
            "source ten-level lineage carryover",
            "source nine-level lineage carryover",
            "reviewed before after and verification evidence gates",
            "safe after-report fixture",
            "schema governance registration",
            "thirteen-level policy handoff",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-12-zigeffect-causal-app-facing-thirteen-level-application-boundary-design.md",
            "docs/superpowers/plans/2026-06-12-zigeffect-causal-app-facing-thirteen-level-application-boundary-implementation.md",
            "packages/zigeffect/tools/causal_app_facing_thirteen_level_application_boundary.zig",
            "packages/zigeffect/docs/app-facing-thirteen-level-application-boundary.md",
            "packages/zigeffect/test/fixtures/app-facing-thirteen-level-application-boundary-after-safe.txt",
        },
        .branch = "codex/zigeffect-causal-app-facing-thirteen-level-application-boundary",
        .agent_guidance = "Use applied thirteen-level application-boundary evidence to start the thirteen-level policy branch only. Planned artifacts are preparatory and blocked artifacts are stop signs. Do not infer CI enforcement, workflow mutation, GitHub API mutation, app mutation, app runtime integration, live agent projection, raw payload capture, NenDB writes, NenDB adapter execution, Cockroach scope, production health, hosted dashboard, public upload, auto-apply, registry mutation, or mutation authority.",
    },
    .{
        .id = "app-facing-thirteen-level-policy",
        .title = "App-Facing Thirteen-Level Policy",
        .gap_id = "app-facing-thirteen-level-policy",
        .priority = "P1",
        .status = "delivered",
        .summary = "Consumes applied thirteen-level application-boundary evidence, records approve or reject policy evidence, preserves thirteen-level report plus twelve-level, eleven-level, ten-level, and nine-level lineage, and prepares the thirteen-level evaluator branch without mutation authority.",
        .depends_on = &.{"app-facing-thirteen-level-application-boundary"},
        .deliverables = &.{
            "thirteen-level policy schema",
            "short alias build step",
            "approve reject and blocked-source policy artifacts",
            "source thirteen-level application-boundary gates",
            "source thirteen-level report evidence carryover",
            "source twelve-level evaluator policy application and report lineage carryover",
            "source eleven-level lineage carryover",
            "source ten-level lineage carryover",
            "source nine-level lineage carryover",
            "denied inference and negative fixture catalogs",
            "schema governance registration",
            "thirteen-level evaluator handoff",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-12-zigeffect-causal-app-facing-thirteen-level-policy-design.md",
            "docs/superpowers/plans/2026-06-12-zigeffect-causal-app-facing-thirteen-level-policy-implementation.md",
            "packages/zigeffect/tools/causal_app_facing_thirteen_level_policy.zig",
            "packages/zigeffect/docs/app-facing-thirteen-level-policy.md",
        },
        .branch = "codex/zigeffect-causal-app-facing-thirteen-level-policy",
        .agent_guidance = "Use approved thirteen-level policy evidence to start the thirteen-level evaluator branch only. Rejected or blocked artifacts are stop signs. Do not infer CI enforcement, workflow mutation, GitHub API mutation, app mutation, app runtime integration, live agent projection, raw payload capture, NenDB writes, NenDB adapter execution, Cockroach scope, production health, hosted dashboard, public upload, auto-apply, registry mutation, or mutation authority.",
    },
    .{
        .id = "app-facing-thirteen-level-evaluator",
        .title = "App-Facing Thirteen-Level Evaluator",
        .gap_id = "app-facing-thirteen-level-evaluator",
        .priority = "P1",
        .status = "delivered",
        .summary = "Consumes approved thirteen-level policy evidence plus bounded local request and support evidence, emits ready advisory or blocked evaluator findings, preserves thirteen-level policy application and report evidence plus twelve-level evaluator policy application and report lineage, and prepares the fourteen-level report branch without mutation authority.",
        .depends_on = &.{"app-facing-thirteen-level-policy"},
        .deliverables = &.{
            "thirteen-level evaluator schema",
            "short alias build step",
            "ready advisory and blocked evaluator artifacts",
            "source thirteen-level policy gates",
            "source thirteen-level application-boundary and report carryover",
            "source twelve-level evaluator and policy carryover",
            "source twelve-level application and report evidence carryover",
            "source eleven-level lineage carryover",
            "source ten-level lineage carryover",
            "source nine-level lineage carryover",
            "bounded request and support evidence classification",
            "schema governance registration",
            "fourteen-level report handoff",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-12-zigeffect-causal-app-facing-thirteen-level-evaluator-design.md",
            "docs/superpowers/plans/2026-06-12-zigeffect-causal-app-facing-thirteen-level-evaluator-implementation.md",
            "packages/zigeffect/tools/causal_app_facing_thirteen_level_evaluator.zig",
            "packages/zigeffect/docs/app-facing-thirteen-level-evaluator.md",
        },
        .branch = "codex/zigeffect-causal-app-facing-thirteen-level-evaluator",
        .agent_guidance = "Use ready or advisory thirteen-level evaluator evidence to start the fourteen-level report branch only. Blocked artifacts are stop signs. Missing support evidence is advisory and must remain visible. Do not infer CI enforcement, workflow mutation, GitHub API mutation, app mutation, app runtime integration, live agent projection, raw payload capture, NenDB writes, NenDB adapter execution, Cockroach scope, production health, hosted dashboard, public upload, auto-apply, registry mutation, or mutation authority.",
    },
    .{
        .id = "app-facing-fourteen-level-report",
        .title = "App-Facing Fourteen-Level Report",
        .gap_id = "app-facing-fourteen-level-report",
        .priority = "P1",
        .status = "delivered",
        .summary = "Consumes ready or advisory thirteen-level evaluator evidence, emits local fourteen-level report JSON/text, preserves thirteen-level policy application and report evidence plus twelve-level evaluator policy application and report lineage, and prepares the fourteen-level application-boundary branch without mutation authority.",
        .depends_on = &.{"app-facing-thirteen-level-evaluator"},
        .deliverables = &.{
            "fourteen-level report schema",
            "short alias build step",
            "ready advisory and blocked report artifacts",
            "source thirteen-level evaluator gates",
            "source thirteen-level policy application and report evidence carryover",
            "source twelve-level evaluator and policy carryover",
            "source twelve-level application and report evidence carryover",
            "source eleven-level lineage carryover",
            "source ten-level lineage carryover",
            "source nine-level lineage carryover",
            "local publication channel catalog",
            "schema governance registration",
            "fourteen-level application-boundary handoff",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-12-zigeffect-causal-app-facing-fourteen-level-report-design.md",
            "docs/superpowers/plans/2026-06-12-zigeffect-causal-app-facing-fourteen-level-report-implementation.md",
        ...
        .branch = "codex/zigeffect-causal-app-facing-fourteen-level-report",
        .agent_guidance = "Use ready or advisory fourteen-level report evidence to start the fourteen-level application-boundary branch only. Blocked artifacts are stop signs. Do not infer CI enforcement, workflow mutation, GitHub API mutation, app mutation, app runtime integration, live agent projection, raw payload capture, NenDB writes, NenDB adapter execution, Cockroach scope, production health, hosted dashboard, public upload, auto-apply, registry mutation, or mutation authority.",
    },
    .{
        .id = "app-facing-fourteen-level-application-boundary",
        .title = "App-Facing Fourteen-Level Application Boundary",
        .gap_id = "app-facing-fourteen-level-application-boundary",
        .priority = "P1",
        .status = "delivered",
        .summary = "Consumes ready or advisory fourteen-level report evidence, records planned or reviewed local application-boundary evidence, preserves fourteen-level report plus thirteen-level evaluator policy application and report lineage and twelve-level/lower lineage, and prepares the fourteen-level policy branch without mutation authority.",
        .depends_on = &.{"app-facing-fourteen-level-report"},
        .deliverables = &.{
            "fourteen-level application-boundary schema",
            "short alias build step",
            "plan applied and blocked boundary artifacts",
            "source fourteen-level report gates",
            "source thirteen-level evaluator policy application and report carryover",
            "source twelve-level evaluator and policy lineage carryover",
            "source eleven-level lineage carryover",
            "source ten-level lineage carryover",
            "source nine-level lineage carryover",
            "safe after-report fixture",
            "schema governance registration",
            "fourteen-level policy handoff",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-12-zigeffect-causal-app-facing-fourteen-level-application-boundary-design.md",
            "docs/superpowers/plans/2026-06-12-zigeffect-causal-app-facing-fourteen-level-application-boundary-implementation.md",
            "packages/zigeffect/tools/causal_app_facing_fourteen_level_application_boundary.zig",
            "packages/zigeffect/docs/app-facing-fourteen-level-application-boundary.md",
            "packages/zigeffect/test/fixtures/app-facing-fourteen-level-application-boundary-after-safe.txt",
        },
        .branch = "codex/zigeffect-causal-app-facing-fourteen-level-application-boundary",
        .agent_guidance = "Use applied fourteen-level application-boundary evidence to start the fourteen-level policy branch only. Planned artifacts are preparatory. Blocked artifacts are stop signs. Do not infer CI enforcement, workflow mutation, GitHub API mutation, app mutation, app runtime integration, live agent projection, raw payload capture, NenDB writes, NenDB adapter execution, Cockroach scope, production health, hosted dashboard, public upload, auto-apply, registry mutation, or mutation authority.",
    },
    .{
        .id = "causal-dev-harness-recovery",
        ...
        .deliverables = &.{
            ...
            "failed-test causal CI report generation",
            "agent-readable event ids findings and next queries",
            "before after causal trace comparison",
            "bounded local artifact retention",
            "NenDB adapter direction preserved without Cockroach scope",
        },
        .evidence_sources = &.{
            "docs/superpowers/specs/2026-06-08-zigeffect-causal-agent-runtime-master-roadmap.md",
            "packages/zigeffect/docs/agent-observable-runtime.md",
...
const dependency_order: []const []const u8 = &.{
    ...
    "app-facing-fourteen-level-application-boundary",
    "causal-dev-harness-recovery",
};
...
const verification_commands: []const []const u8 = &.{
    ...
    "zig build causal-app-facing-thirteen-level-application-boundary -- --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-report.json plan --reason \"planned app-facing thirteen-level application boundary\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary-plan",
    "zig build causal-app-facing-thirteen-level-application-boundary -- --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-report.json record-applied --reason \"reviewed app-facing thirteen-level application boundary\" --after-report test/fixtures/app-facing-thirteen-level-application-boundary-after-safe.txt --application-change \"reviewed local thirteen-level application boundary for agents reviewers CI advisory readers and SolidJS webui\" --before \"before local thirteen-level application boundary evidence\" --after \"after local thirteen-level application boundary evidence\" --verified-command \"bun run zigeffect:workbench:typecheck\" --verified-command \"bun run zigeffect:workbench:test\" --verified-command \"zig build causal-app-facing-thirteen-level-report -- --help\" --verified-command \"zig build causal-schema-governance -- --format json\" --verified-command \"zig build causal-production-hardening-backlog -- --format json\" --verified-command \"zig build examples\" --verified-command \"zig build test\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary",
    "zig build causal-app-facing-thirteen-level-application-boundary -- --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-report-blocked.json record-applied --reason \"blocked app-facing thirteen-level application boundary source\" --after-report test/fixtures/app-facing-thirteen-level-application-boundary-after-safe.txt --application-change \"reviewed local thirteen-level blocked source boundary probe\" --before \"before local thirteen-level blocked source evidence\" --after \"after local thirteen-level blocked source evidence\" --verified-command \"bun run zigeffect:workbench:typecheck\" --verified-command \"bun run zigeffect:workbench:test\" --verified-command \"zig build causal-app-facing-thirteen-level-report -- --help\" --verified-command \"zig build causal-schema-governance -- --format json\" --verified-command \"zig build causal-production-hardening-backlog -- --format json\" --verified-command \"zig build examples\" --verified-command \"zig build test\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary-blocked",
    "zig build causal-app-facing-thirteen-level-policy -- --help",
    "zig build causal-app-facing-thirteen-level-policy -- --from-application ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary.json approve --reason \"reviewed app-facing thirteen-level policy\" --verified-command \"bun run zigeffect:workbench:typecheck\" --verified-command \"bun run zigeffect:workbench:test\" --verified-command \"zig build causal-app-facing-thirteen-level-application-boundary -- --help\" --verified-command \"zig build causal-schema-governance -- --format json\" --verified-command \"zig build causal-production-hardening-backlog -- --format json\" --verified-command \"zig build examples\" --verified-command \"zig build test\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy",
    "zig build causal-app-facing-thirteen-level-policy -- --from-application ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary.json reject --reason \"rejected app-facing thirteen-level policy\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy-reject",
    "zig build causal-app-facing-thirteen-level-policy -- --from-application ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary-blocked.json approve --reason \"blocked source app-facing thirteen-level policy\" --verified-command \"bun run zigeffect:workbench:typecheck\" --verified-command \"bun run zigeffect:workbench:test\" --verified-command \"zig build causal-app-facing-thirteen-level-application-boundary -- --help\" --verified-command \"zig build causal-schema-governance -- --format json\" --verified-command \"zig build causal-production-hardening-backlog -- --format json\" --verified-command \"zig build examples\" --verified-command \"zig build test\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy-blocked",
    "zig build causal-app-facing-thirteen-level-evaluator -- --help",
    "zig build causal-app-facing-thirteen-level-evaluator -- --from-policy ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.json evaluate --reason \"reviewed app-facing thirteen-level evaluator\" --request ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-request.json --evidence ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-support.txt --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator",
    "zig build causal-app-facing-thirteen-level-evaluator -- --from-policy ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.json evaluate --reason \"advisory app-facing thirteen-level evaluator missing support\" --request ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-request.json --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-advisory",
    "zig build causal-app-facing-thirteen-level-evaluator -- --from-policy ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy-reject.json evaluate --reason \"blocked app-facing thirteen-level evaluator source\" --request ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-request.json --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator-blocked",
    ...
    "zig build causal-app-facing-fourteen-level-application-boundary -- --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-fourteen-level-report-blocked.json record-applied --reason \"blocked app-facing fourteen-level application boundary source\" --after-report test/fixtures/app-facing-fourteen-level-application-boundary-after-safe.txt --application-change \"reviewed local fourteen-level blocked source boundary probe\" --before \"before local fourteen-level blocked source evidence\" --after \"after local fourteen-level blocked source evidence\" --verified-command \"bun run zigeffect:workbench:typecheck\" --verified-command \"bun run zigeffect:workbench:test\" --verified-command \"zig build causal-app-facing-fourteen-level-report -- --help\" --verified-command \"zig build causal-schema-governance -- --format json\" --verified-command \"zig build causal-production-hardening-backlog -- --format json\" --verified-command \"zig build examples\" --verified-command \"zig build test\" --out-prefix ../../.zig-cache/causal-artifacts/app-facing-ci-fourteen-level-application-boundary-blocked",
...
test "production hardening backlog exposes branch-ready items" {
    ...
    try expectBacklogItem("app-facing-thirteen-level-application-boundary");
    try expectBacklogItemStatus("app-facing-thirteen-level-application-boundary", "delivered");
    try expectBacklogItem("app-facing-thirteen-level-policy");
    try expectBacklogItemStatus("app-facing-thirteen-level-policy", "delivered");
    try expectBacklogItem("app-facing-thirteen-level-evaluator");
    try expectBacklogItemStatus("app-facing-thirteen-level-evaluator", "delivered");
    try expectBacklogItem("app-facing-fourteen-level-report");
    try expectBacklogItemStatus("app-facing-fourteen-level-report", "delivered");
...
test "production hardening backlog text mentions dependency order and next branch" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, report, "app-facing-thirteen-level-application-boundary") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "causal-app-facing-thirteen-level-application-boundary") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "app-facing-thirteen-level-policy") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "causal-app-facing-thirteen-level-policy") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "app-facing-thirteen-level-evaluator") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "causal-app-facing-thirteen-level-evaluator") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "app-facing-fourteen-level-report") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "causal-app-facing-fourteen-level-report") != null);
...
test "production hardening backlog JSON is agent-readable" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, report, "\"id\": \"app-facing-thirteen-level-application-boundary\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"branch\": \"codex/zigeffect-causal-app-facing-thirteen-level-application-boundary\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "zig build causal-app-facing-thirteen-level-application-boundary -- --help") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"id\": \"app-facing-thirteen-level-policy\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"branch\": \"codex/zigeffect-causal-app-facing-thirteen-level-policy\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "zig build causal-app-facing-thirteen-level-policy -- --help") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"id\": \"app-facing-thirteen-level-evaluator\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"branch\": \"codex/zigeffect-causal-app-facing-thirteen-level-evaluator\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "zig build causal-app-facing-thirteen-level-evaluator -- --help") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"id\": \"app-facing-fourteen-level-report\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "\"branch\": \"codex/zigeffect-causal-app-facing-fourteen-level-report\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, report, "zig build causal-app-facing-fourteen-level-report -- --help") != null);
