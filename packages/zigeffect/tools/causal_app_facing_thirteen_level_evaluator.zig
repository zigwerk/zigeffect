...
pub const source_branch = "codex/zigeffect-causal-app-facing-thirteen-level-evaluator";
pub const recommendation = "start-app-facing-fourteen-level-report";
pub const next_branch_if_ready = "codex/zigeffect-causal-app-facing-fourteen-level-report";
...
const generated_by = "causal-app-facing-thirteen-level-evaluator";
const source_policy_suffix = "-ci-thirteen-level-policy.json";
const output_prefix_suffix = "-ci-thirteen-level-evaluator";
const compact_output_prefix_name = "app-facing-ci-thirteen-level-evaluator";
...
const Options = struct {
    ...
    reason: []const u8,
    reviewed_by: []const u8 = "app-facing-thirteen-level-evaluator-reviewer",
    policy: []const u8 = "manual-app-facing-thirteen-level-evaluator",
...
const SourcePolicyArtifact = struct {
    ...
    source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status: []const u8 = "",
    source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest: []const u8 = "",
    source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present: bool = false,
    source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes: []const []const u8 = &.{},
...
fn parseOptions(allocator: std.mem.Allocator, args: []const []const u8) !Options {
    ...
    var reviewed_by: []const u8 = "app-facing-thirteen-level-evaluator-reviewer";
    var policy: []const u8 = "manual-app-facing-thirteen-level-evaluator";
...
fn classifyFile(path: []const u8, contents: []const u8, detected_schema: []const u8) FileClass {
    ...
    if (is_json and (std.mem.indexOf(u8, path, "thirteen-level-policy") != null or std.mem.indexOf(u8, path, "consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-policy") != null or std.mem.eql(u8, detected_schema, source_policy_schema))) return .policy_json;
...
fn evaluatePolicyAndFiles(
    ...
    try appendCheckAndFinding(allocator, &checks, &findings, "source-report-policy-ready", std.mem.eql(u8, source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status, "ready"), "source-report-policy-valid", "source consumption report policy status is ready");
...
fn sourceThirteenLevelRefsPresent(source: SourcePolicyArtifact) bool {
    return sourceThirteenLevelApplicationBoundary(source).len > 0 and
        ...
        sourceThirteenLevelAfterDigest(source).len > 0 and
        sourceThirteenLevelAfterPresent(source);
}
...
fn sourceTwelveLevelRefsPresent(source: SourcePolicyArtifact) bool {
    return source.source_twelve_level_evaluator.len > 0 and
        ...
        sourceTwelveLevelAfterDigest(source).len > 0 and
        sourceTwelveLevelAfterPresent(source);
}

fn sourceElevenLevelRefsPresent(source: SourcePolicyArtifact) bool {
...
fn sourceTenLevelRefsPresent(source: SourcePolicyArtifact) bool {
...
fn sourceThirteenLevelApplicationBoundary(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_application_boundary;
}

fn sourceThirteenLevelApplicationBoundarySchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_application_boundary_schema;
}

fn sourceThirteenLevelApplicationBoundaryStatus(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_application_boundary_status;
}

fn sourceThirteenLevelReport(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_report;
}

fn sourceThirteenLevelReportSchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_report_schema;
}

fn sourceThirteenLevelReportStatus(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_report_status;
}

fn sourceTwelveLevelApplicationBoundary(source: SourcePolicyArtifact) []const u8 {
    return source.source_twelve_level_application_boundary;
}

fn sourceTwelveLevelApplicationBoundarySchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_twelve_level_application_boundary_schema;
}

fn sourceTwelveLevelReport(source: SourcePolicyArtifact) []const u8 {
    return source.source_twelve_level_report;
}

fn sourceTwelveLevelReportSchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_twelve_level_report_schema;
}

fn sourceTwelveLevelReportStatus(source: SourcePolicyArtifact) []const u8 {
...
fn sourceThirteenLevelAfterDigest(source: SourcePolicyArtifact) []const u8 {
    return source.source_thirteen_level_after_digest;
}

fn sourceThirteenLevelAfterPresent(source: SourcePolicyArtifact) bool {
    return source.source_thirteen_level_after_present;
}

fn sourceTwelveLevelAfterDigest(source: SourcePolicyArtifact) []const u8 {
    return source.source_twelve_level_after_digest;
}

fn sourceTwelveLevelAfterPresent(source: SourcePolicyArtifact) bool {
    return source.source_twelve_level_after_present;
}
...
fn formatEvaluatorJson(
    ...
    try appendJsonField(allocator, &output, "source_thirteen_level_policy", options.policy_path, true);
    try appendJsonField(allocator, &output, "source_thirteen_level_policy_schema", source.schema, true);
    try appendJsonField(allocator, &output, "source_thirteen_level_policy_status", source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status, true);
    ...
    try appendJsonField(allocator, &output, "source_thirteen_level_after_digest", sourceThirteenLevelAfterDigest(source), true);
    ...
    try appendJsonField(allocator, &output, "source_twelve_level_after_digest", sourceTwelveLevelAfterDigest(source), true);
    ...
    try appendJsonField(allocator, &output, "source_ten_level_after_digest", source.source_ten_level_after_digest, true);
    try output.print(allocator, "  \"source_ten_level_after_present\": {},\n", .{source.source_ten_level_after_present});
    ...
    try appendJsonField(allocator, &output, "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluator_status", evaluationStatusText(result.status), true);
...
fn formatEvaluatorText(
    ...
    try output.print(allocator, "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluator_status: {s}\n", .{evaluationStatusText(result.status)});
    try output.print(allocator, "ready_for_next_branch: {}\n", .{result.ready_for_next_branch});
    try output.print(allocator, "advisory_findings_count: {d}\n", .{result.advisory_findings_count});
    try output.print(allocator, "blocked_findings_count: {d}\n", .{result.blocked_findings_count});
    try output.print(allocator, "mutation_authority: {s}\n", .{mutation_authority});
    try output.print(allocator, "source_thirteen_level_policy: {s}\n", .{options.policy_path});
    try output.print(allocator, "source_thirteen_level_policy_schema: {s}\n", .{source.schema});
    try output.print(allocator, "source_thirteen_level_policy_status: {s}\n", .{source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status});
    try output.print(allocator, "source_thirteen_level_application_boundary: {s}\n", .{sourceThirteenLevelApplicationBoundary(source)});
    try output.print(allocator, "source_thirteen_level_application_boundary_schema: {s}\n", .{sourceThirteenLevelApplicationBoundarySchema(source)});
...
fn nextQueries(status: EvaluationStatus) []const []const u8 {
    return switch (status) {
        .ready => &.{
            "causal-query --artifact <app-facing-ci-thirteen-level-evaluator.json> --kind request",
            "causal-query --artifact <app-facing-ci-thirteen-level-evaluator.json> --kind denied-claim",
            "start codex/zigeffect-causal-app-facing-fourteen-level-report with this evaluator artifact",
        },
        .advisory_findings => &.{
            "add support evidence for the request and rerun the evaluator",
            "inspect advisory findings before rendering a fourteen-level report",
        },
        .blocked => &.{
...
fn agentGuidance(status: EvaluationStatus) []const []const u8 {
    return switch (status) {
        .ready => &.{
            "Ready thirteen-level evaluator artifacts may feed a local fourteen-level report.",
...
fn usage() []const u8 {
    return "usage: zig build causal-app-facing-thirteen-level-evaluator -- --from-policy <thirteen-level-policy.json> evaluate --reason <reason> --request <path>... [--evidence <path>]... [--by <actor>] [--policy <policy>] [--out-prefix <path-prefix>]\n";
}

fn failUsage(err: anyerror) noreturn {
    std.debug.print("causal-app-facing-thirteen-level-evaluator error: {s}\n{s}", .{ @errorName(err), usage() });
    std.process.exit(2);
}
...
fn readyPolicyJson() []const u8 {
    ...
    \\  "schema_version": 1,
    \\  "decision": "approve",
    \\  "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status": "ready",
    ...
    \\  "source_ten_level_after_digest": "sha256:ten-after",
    ...
    \\  "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status": "applied",
    \\  "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest": "sha256:eleven-after",
    \\  "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present": true,
    \\  "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes": ["reviewed local eleven-level application boundary"],
...
fn blockedPolicyJson() []const u8 {
    ...
    \\  "schema_version": 1,
    \\  "decision": "reject",
    \\  "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status": "blocked",
...
test "app-facing thirteen-level evaluator constants are stable" {
    try std.testing.expectEqualStrings(
        "zigeffect.causal.app-facing-production-integration-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluator.v1",
        schema,
    );
    try std.testing.expectEqual(@as(u32, 1), schema_version);
    try std.testing.expectEqualStrings("codex/zigeffect-causal-app-facing-thirteen-level-evaluator", source_branch);
    try std.testing.expectEqualStrings("start-app-facing-fourteen-level-report", recommendation);
    try std.testing.expectEqualStrings("codex/zigeffect-causal-app-facing-fourteen-level-report", next_branch_if_ready);
}

test "parses app-facing thirteen-level evaluator options with requests and evidence" {
    var options = try parseOptions(std.testing.allocator, &.{
        "zigeffect-causal-app-facing-thirteen-level-evaluator",
        "--from-policy",
        ...
        "codex",
        "--policy",
        "manual-app-facing-thirteen-level-evaluator",
        "--request",
        ...
        "--out-prefix",
        ".zig-cache/causal-artifacts/custom-app-facing-ci-thirteen-level-evaluator",
    });
    defer options.deinit(std.testing.allocator);

    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.json", options.policy_path);
    ...
    try std.testing.expectEqualStrings("manual-app-facing-thirteen-level-evaluator", options.policy);
    ...
    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/custom-app-facing-ci-thirteen-level-evaluator", options.out_prefix.?);
}
...
test "default output path replaces report policy suffix" {
    ...
    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator.json", paths.json_path);
    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-evaluator.txt", paths.text_path);
}
...
test "classifies request policy causal workbench and denied files" {
    var evidence = try analyzeFiles(std.testing.allocator, &.{
        ...
        .{ .path = ".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.json", .contents = readyPolicyJson() },
...
test "ready advisory and blocked evaluator output preserve read-only authority" {
    var ready_options = try parseOptions(std.testing.allocator, &.{
        "tool",
        "--from-policy",
        "source-app-facing-ci-thirteen-level-policy.json",
        "evaluate",
        "--reason",
    ...
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluator_status\": \"ready\"") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_policy\": \"source-app-facing-ci-thirteen-level-policy.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_application_boundary\": \"app-facing-ci-thirteen-level-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_application_boundary_status\": \"applied\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_report\": \"app-facing-ci-thirteen-level-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_after_digest\": \"sha256:thirteen-after\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_after_present\": true") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_thirteen_level_application_changes\": [\"reviewed local thirteen-level application boundary\"]") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_evaluator\": \"app-facing-ci-twelve-level-evaluator.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_evaluator_status\": \"ready\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_policy\": \"app-facing-ci-twelve-level-policy.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_application_boundary\": \"app-facing-ci-twelve-level-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_report\": \"app-facing-ci-twelve-level-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_after_digest\": \"sha256:twelve-after\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_after_present\": true") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_twelve_level_application_changes\": [\"reviewed local twelve-level application boundary\"]") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_eleven_level_policy\": \"app-facing-ci-eleven-level-policy.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_eleven_level_application_boundary\": \"app-facing-ci-eleven-level-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_eleven_level_report\": \"app-facing-ci-eleven-level-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_eleven_level_application_changes\": [\"reviewed local eleven-level application boundary\"]") != null);
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_ten_level_policy\": \"app-facing-ci-ten-level-policy.json\"") != null);
