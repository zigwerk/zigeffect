...
const Options = struct {
    ...
    decision: Decision,
    reviewed_by: []const u8 = "app-facing-thirteen-level-policy-reviewer",
    policy: []const u8 = "manual-app-facing-thirteen-level-policy",
    reason: []const u8,
...
const SourceApplicationArtifact = struct {
    ...
    mode: []const u8,
    evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status: []const u8,
    applied: bool,
    ...
    policy: []const u8 = "",
    reason: []const u8 = "",
    evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_path: ?[]const u8 = null,
    evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest: []const u8 = "",
    evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present: bool = false,
    source_blocked_findings_count: usize = 0,
    source_advisory_findings_count: usize = 0,
    evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes: []const []const u8 = &.{},
...
const negative_fixtures: []const NegativeFixture = &.{
    .{ .id = "planned-application-boundary-denied", .artifact_state = "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status=planned", .decision = "deny", .failed_gate = "source-applied-application", .reason = "policy approval requires an applied consumption-report evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report application-boundary artifact" },
    .{ .id = "missing-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-application-evidence-denied", .artifact_state = "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes=[]", .decision = "deny", .failed_gate = "source-application-evidence-present", .reason = "policy approval requires reviewed evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report application evidence" },
...
fn parseOptions(allocator: std.mem.Allocator, args: []const []const u8) !Options {
    ...
    var reviewed_by: []const u8 = "app-facing-thirteen-level-policy-reviewer";
    var policy: []const u8 = "manual-app-facing-thirteen-level-policy";
...
fn sourceIsAppliedBoundary(source: SourceApplicationArtifact) bool {
    return std.mem.eql(u8, source.generated_by, "causal-app-facing-thirteen-level-application-boundary") and
        std.mem.eql(u8, source.mode, "record-applied") and
        std.mem.eql(u8, source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status, "applied") and
        source.applied and
...
fn sourceRefsPresent(source: SourceApplicationArtifact) bool {
    return sourceThirteenLevelRefsPresent(source) and
        ...
        source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest.len > 0;
}

fn sourceThirteenLevelRefsPresent(source: SourceApplicationArtifact) bool {
    return sourceThirteenLevelReport(source).len > 0 and
        sourceThirteenLevelReportSchema(source).len > 0 and
        std.mem.eql(u8, sourceThirteenLevelReportStatus(source), "ready") and
        source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest.len > 0 and
        source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present;
}
...
fn sourceElevenLevelRefsPresent(source: SourceApplicationArtifact) bool {
    return source.source_eleven_level_policy.len > 0 and
        ...
        std.mem.eql(u8, source.source_eleven_level_report_status, "ready") and
        source.source_eleven_level_after_digest.len > 0 and
...
fn sourceThirteenLevelReport(source: SourceApplicationArtifact) []const u8 {
    if (source.source_thirteen_level_report.len > 0) return source.source_thirteen_level_report;
...
fn sourceThirteenLevelReportSchema(source: SourceApplicationArtifact) []const u8 {
    if (source.source_thirteen_level_report_schema.len > 0) return source.source_thirteen_level_report_schema;
    return "";
}

fn sourceThirteenLevelReportStatus(source: SourceApplicationArtifact) []const u8 {
    if (source.source_thirteen_level_report_status.len > 0) return source.source_thirteen_level_report_status;
...
fn sourceEvidencePresent(source: SourceApplicationArtifact) bool {
    return source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes.len > 0 and
        source.before_evidence.len > 0 and
        source.after_evidence.len > 0 and
        source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present and
...
fn formatPolicyJson(allocator: std.mem.Allocator, options: Options, source: SourceApplicationArtifact, result: PolicyResult, paths: OutputPaths) ![]const u8 {
    ...
    try appendJsonField(allocator, &output, "source_thirteen_level_application_boundary", options.application_path, true);
    try appendJsonField(allocator, &output, "source_thirteen_level_application_boundary_schema", source.schema, true);
    try appendJsonField(allocator, &output, "source_thirteen_level_application_boundary_status", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status, true);
    ...
    try appendJsonField(allocator, &output, "source_thirteen_level_after_digest", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest, true);
    ...
    try appendJsonField(allocator, &output, "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status, true);
    ...
    try appendJsonField(allocator, &output, "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest, true);
    try output.print(allocator, "  \"source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present\": {},\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present});
    ...
    try appendStringArray(allocator, &output, source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes);
    ...
    try output.appendSlice(allocator, ",\n  \"source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes\": ");
    try appendStringArray(allocator, &output, source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes);
...
fn formatPolicyText(allocator: std.mem.Allocator, options: Options, source: SourceApplicationArtifact, result: PolicyResult, paths: OutputPaths) ![]const u8 {
    ...
    try output.print(allocator, "source_thirteen_level_application_boundary: {s}\n", .{options.application_path});
    try output.print(allocator, "source_thirteen_level_application_boundary_schema: {s}\n", .{source.schema});
    try output.print(allocator, "source_thirteen_level_application_boundary_status: {s}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status});
    try output.print(allocator, "source_thirteen_level_report: {s}\n", .{sourceThirteenLevelReport(source)});
    try output.print(allocator, "source_thirteen_level_report_schema: {s}\n", .{sourceThirteenLevelReportSchema(source)});
    try output.print(allocator, "source_thirteen_level_report_status: {s}\n", .{sourceThirteenLevelReportStatus(source)});
    try output.print(allocator, "source_thirteen_level_after_digest: {s}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest});
    try output.print(allocator, "source_thirteen_level_after_present: {}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present});
    try output.print(allocator, "source_twelve_level_evaluator: {s}\n", .{source.source_twelve_level_evaluator});
    try output.print(allocator, "source_twelve_level_evaluator_schema: {s}\n", .{source.source_twelve_level_evaluator_schema});
    try output.print(allocator, "source_twelve_level_evaluator_status: {s}\n", .{source.source_twelve_level_evaluator_status});
    try output.print(allocator, "source_twelve_level_policy: {s}\n", .{source.source_twelve_level_policy});
    try output.print(allocator, "source_twelve_level_policy_schema: {s}\n", .{source.source_twelve_level_policy_schema});
    try output.print(allocator, "source_twelve_level_policy_status: {s}\n", .{source.source_twelve_level_policy_status});
    try output.print(allocator, "source_twelve_level_application_boundary: {s}\n", .{source.source_twelve_level_application_boundary});
    try output.print(allocator, "source_twelve_level_application_boundary_schema: {s}\n", .{source.source_twelve_level_application_boundary_schema});
    try output.print(allocator, "source_twelve_level_report: {s}\n", .{source.source_twelve_level_report});
    try output.print(allocator, "source_twelve_level_report_schema: {s}\n", .{source.source_twelve_level_report_schema});
    try output.print(allocator, "source_twelve_level_report_status: {s}\n", .{source.source_twelve_level_report_status});
    try output.print(allocator, "source_twelve_level_after_digest: {s}\n", .{source.source_twelve_level_after_digest});
    try output.print(allocator, "source_twelve_level_after_present: {}\n", .{source.source_twelve_level_after_present});
    try output.print(allocator, "source_eleven_level_policy: {s}\n", .{source.source_eleven_level_policy});
    try output.print(allocator, "source_eleven_level_policy_status: {s}\n", .{source.source_eleven_level_policy_status});
    ...
    try output.print(allocator, "source_eleven_level_after_digest: {s}\n", .{source.source_eleven_level_after_digest});
    try output.print(allocator, "source_eleven_level_after_present: {}\n", .{source.source_eleven_level_after_present});
    ...
    try output.print(allocator, "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status: {s}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status});
    ...
    try output.print(allocator, "source_report_after_present: {}\n", .{source.source_report_after_present});
    try output.print(allocator, "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest: {s}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest});
    try output.print(allocator, "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present: {}\n", .{source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present});
    ...
    try appendTextList(allocator, &output, "source thirteen-level application changes", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes);
    ...
    try appendTextList(allocator, &output, "source evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report application changes", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes);
...
fn usage() []const u8 {
    return "usage: zig build causal-app-facing-thirteen-level-policy -- --from-application <thirteen-level-application-boundary.json> approve|reject --reason <reason> [--by <actor>] [--policy <policy>] [--verified-command <command>]... [--out-prefix <path-prefix>]\n";
}

fn failUsage(err: anyerror) noreturn {
    std.debug.print("causal-app-facing-thirteen-level-policy error: {s}\n{s}", .{ @errorName(err), usage() });
    std.process.exit(2);
}
...
fn readyApplicationBoundaryJson() []const u8 {
    ...
    \\  "schema": "zigeffect.causal.app-facing-production-integration-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-application-boundary.v1",
    \\  "schema_version": 1,
    \\  "generated_by": "causal-app-facing-thirteen-level-application-boundary",
    ...
    \\  "source_twelve_level_report": "app-facing-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report.json",
    ...
    \\  "source_twelve_level_after_digest": "sha256:twelve-level-after",
    ...
    \\  "source_eleven_level_after_digest": "sha256:eleven-level-after",
    ...
    \\  "mode": "record-applied",
    \\  "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_status": "applied",
    \\  "applied": true,
    ...
    \\  "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present": true,
...
test "app-facing advisory remediation report consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report policy schema and branch constants are stable" {
    ...
    try std.testing.expectEqualStrings(
        "start-app-facing-thirteen-level-evaluator",
        recommendation,
    );
    try std.testing.expectEqualStrings(
...
test "default output path replaces boundary suffix and compacts long names" {
    const paths = try defaultOutputPaths(
        ...
        ".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-application-boundary.json",
    );
    defer paths.deinit(std.testing.allocator);

    try std.testing.expectEqualStrings(
        ".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.json",
        paths.json_path,
    );
    try std.testing.expectEqualStrings(
        ".zig-cache/causal-artifacts/app-facing-ci-thirteen-level-policy.txt",
        paths.text_path,
    );
...
test "approved and rejected consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report policy output preserve read-only authority" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_thirteen_level_application_boundary\": \"source-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_thirteen_level_report\": \"app-facing-ci-thirteen-level-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_thirteen_level_after_digest\": \"sha256:after-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_thirteen_level_application_changes\": [\"reviewed local consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report application boundary for agents reviewers CI advisory readers and SolidJS webui\"]") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_evaluator\": \"app-facing-ci-twelve-level-evaluator.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_policy\": \"app-facing-ci-twelve-level-policy.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_application_boundary\": \"app-facing-ci-twelve-level-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_report\": \"app-facing-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_after_digest\": \"sha256:twelve-level-after\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_application_changes\": [\"reviewed local twelve-level application boundary\"]") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_eleven_level_policy\": \"app-facing-ci-eleven-level-policy.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_eleven_level_application_boundary\": \"app-facing-ci-eleven-level-application-boundary.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_eleven_level_report\": \"app-facing-ci-eleven-level-report.json\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_eleven_level_application_changes\": [\"reviewed local eleven-level application boundary\"]") != null);
...
test "unsafe source and missing verification block approved consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report policy" {
    ...
    const unsafe_source = try formatReports(std.testing.allocator, .{
        ...
        \\  "source_report_after_digest": "sha256:source-report-after",
        \\  "source_report_after_present": true,
        \\  "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest": "sha256:after",
        \\  "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present": true,
        \\  "evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes": ["change"],
