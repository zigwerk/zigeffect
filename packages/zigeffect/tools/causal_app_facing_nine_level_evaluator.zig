...
const source_policy_suffix = "-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-policy.json";
const output_prefix_suffix = "-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluator";
...
const Options = struct {
    ...
    reason: []const u8,
    reviewed_by: []const u8 = "app-facing-nine-level-evaluator-reviewer",
    policy: []const u8 = "manual-app-facing-nine-level-evaluator",
...
fn parseOptions(allocator: std.mem.Allocator, args: []const []const u8) !Options {
    ...
    var reviewed_by: []const u8 = "app-facing-nine-level-evaluator-reviewer";
    var policy: []const u8 = "manual-app-facing-nine-level-evaluator";
...
fn classifyFile(path: []const u8, contents: []const u8, detected_schema: []const u8) FileClass {
    ...
    if (is_json and (std.mem.indexOf(u8, path, "nine-level-policy") != null or std.mem.indexOf(u8, path, "consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-policy") != null or std.mem.eql(u8, detected_schema, source_policy_schema))) return .policy_json;
...
fn evaluatePolicyAndFiles(
    ...
    try appendCheckAndFinding(allocator, &checks, &findings, "source-report-policy-ready", std.mem.eql(u8, source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status, "ready"), "source-report-policy-valid", "source consumption report policy status is ready");
...
fn sourceRefsPresent(source: SourcePolicyArtifact) bool {
    return sourceNineLevelApplicationBoundary(source).len > 0 and
        ...
        sourceNineLevelAfterDigest(source).len > 0 and
        sourceNineLevelAfterPresent(source) and
...
fn sourceNineLevelApplicationBoundary(source: SourcePolicyArtifact) []const u8 {
    return source.source_nine_level_application_boundary;
}

fn sourceNineLevelApplicationBoundarySchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_nine_level_application_boundary_schema;
}

fn sourceNineLevelReport(source: SourcePolicyArtifact) []const u8 {
    return source.source_nine_level_report;
}

fn sourceNineLevelReportSchema(source: SourcePolicyArtifact) []const u8 {
    return source.source_nine_level_report_schema;
}

fn sourceNineLevelReportStatus(source: SourcePolicyArtifact) []const u8 {
    return source.source_nine_level_report_status;
}
...
fn sourceNineLevelAfterDigest(source: SourcePolicyArtifact) []const u8 {
...
fn sourceNineLevelAfterPresent(source: SourcePolicyArtifact) bool {
    return source.source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_present;
}
...
fn formatEvaluatorJson(
    ...
    try appendJsonField(allocator, &output, "source_nine_level_policy", options.policy_path, true);
    try appendJsonField(allocator, &output, "source_nine_level_policy_schema", source.schema, true);
    try appendJsonField(allocator, &output, "source_nine_level_policy_status", source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status, true);
...
fn formatEvaluatorText(
    ...
    try output.print(allocator, "source_nine_level_policy_schema: {s}\n", .{source.schema});
    try output.print(allocator, "source_nine_level_policy_status: {s}\n", .{source.consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status});
    try output.print(allocator, "source_nine_level_application_boundary: {s}\n", .{sourceNineLevelApplicationBoundary(source)});
    try output.print(allocator, "source_nine_level_application_boundary_schema: {s}\n", .{sourceNineLevelApplicationBoundarySchema(source)});
...
fn nextQueries(status: EvaluationStatus) []const []const u8 {
    return switch (status) {
        .ready => &.{
            "causal-query --artifact <app-facing-ci-nine-level-evaluator.json> --kind request",
            "causal-query --artifact <app-facing-ci-nine-level-evaluator.json> --kind denied-claim",
            "start codex/zigeffect-causal-app-facing-ten-level-report with this evaluator artifact",
        },
        .advisory_findings => &.{
            "add support evidence for the request and rerun the evaluator",
            "inspect advisory findings before rendering a ten-level report",
        },
        .blocked => &.{
...
fn agentGuidance(status: EvaluationStatus) []const []const u8 {
    return switch (status) {
        .ready => &.{
            "Ready nine-level evaluator artifacts may feed a local ten-level report.",
...
fn usage() []const u8 {
    return "usage: zig build causal-app-facing-nine-level-evaluator -- --from-policy <nine-level-policy.json> evaluate --reason <reason> --request <path>... [--evidence <path>]... [--by <actor>] [--policy <policy>] [--out-prefix <path-prefix>]\n";
}

fn failUsage(err: anyerror) noreturn {
    std.debug.print("causal-app-facing-nine-level-evaluator error: {s}\n{s}", .{ @errorName(err), usage() });
    std.process.exit(2);
}
...
fn readyPolicyJson() []const u8 {
    ...
    \\  "schema_version": 1,
    \\  "decision": "approve",
    \\  "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status": "ready",
    ...
    \\  "source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes": ["reviewed local nine-level application boundary"],
...
fn blockedPolicyJson() []const u8 {
    ...
    \\  "schema_version": 1,
    \\  "decision": "reject",
    \\  "consumption_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_policy_status": "blocked",
...
test "parses app-facing nine-level evaluator options with requests and evidence" {
    var options = try parseOptions(std.testing.allocator, &.{
        "zigeffect-causal-app-facing-nine-level-evaluator",
        "--from-policy",
        ".zig-cache/causal-artifacts/app-facing-ci-nine-level-policy.json",
        "evaluate",
        "--reason",
        ...
        "codex",
        "--policy",
        "manual-app-facing-nine-level-evaluator",
        "--request",
        ...
        "--out-prefix",
        ".zig-cache/causal-artifacts/custom-app-facing-ci-nine-level-evaluator",
    });
    defer options.deinit(std.testing.allocator);

    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/app-facing-ci-nine-level-policy.json", options.policy_path);
    ...
    try std.testing.expectEqualStrings("manual-app-facing-nine-level-evaluator", options.policy);
    ...
    try std.testing.expectEqualStrings(".zig-cache/causal-artifacts/custom-app-facing-ci-nine-level-evaluator", options.out_prefix.?);
}
...
test "default output path replaces report policy suffix" {
    ...
    try std.testing.expect(std.mem.startsWith(u8, paths.json_path, ".zig-cache/causal-artifacts/app-facing-ci-advisory-remediation-report-consumption-report-"));
    try std.testing.expect(std.mem.indexOf(u8, paths.json_path, "-evaluator.json") != null);
    try std.testing.expect(std.mem.endsWith(u8, paths.json_path, ".json"));
    try std.testing.expect(std.mem.startsWith(u8, paths.text_path, ".zig-cache/causal-artifacts/app-facing-ci-advisory-remediation-report-consumption-report-"));
    try std.testing.expect(std.mem.indexOf(u8, paths.text_path, "-evaluator.txt") != null);
...
test "classifies request policy causal workbench and denied files" {
    var evidence = try analyzeFiles(std.testing.allocator, &.{
        ...
        .{ .path = ".zig-cache/causal-artifacts/app-facing-ci-nine-level-policy.json", .contents = readyPolicyJson() },
...
test "ready advisory and blocked evaluator output preserve read-only authority" {
    var ready_options = try parseOptions(std.testing.allocator, &.{
        "tool",
        "--from-policy",
        "source-app-facing-ci-nine-level-policy.json",
        "evaluate",
        "--reason",
    ...
    try std.testing.expect(std.mem.indexOf(u8, ready_reports.json, "\"source_nine_level_policy\": \"source-app-facing-ci-nine-level-policy.json\"") != null);
