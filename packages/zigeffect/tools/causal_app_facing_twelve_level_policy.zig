...
const Options = struct {
    ...
    decision: Decision,
    reviewed_by: []const u8 = "app-facing-twelve-level-policy-reviewer",
    policy: []const u8 = "manual-app-facing-twelve-level-policy",
    reason: []const u8,
...
fn parseOptions(allocator: std.mem.Allocator, args: []const []const u8) !Options {
    ...
    var reviewed_by: []const u8 = "app-facing-twelve-level-policy-reviewer";
    var policy: []const u8 = "manual-app-facing-twelve-level-policy";
...
fn sourceRefsPresent(source: SourceApplicationArtifact) bool {
    return sourceTwelveLevelRefsPresent(source) and
...
fn sourceTwelveLevelRefsPresent(source: SourceApplicationArtifact) bool {
    return sourceTwelveLevelReport(source).len > 0 and
...
fn sourceTwelveLevelReport(source: SourceApplicationArtifact) []const u8 {
    if (source.source_twelve_level_report.len > 0) return source.source_twelve_level_report;
...
fn sourceTwelveLevelReportSchema(source: SourceApplicationArtifact) []const u8 {
    if (source.source_twelve_level_report_schema.len > 0) return source.source_twelve_level_report_schema;
    return "";
}

fn sourceTwelveLevelReportStatus(source: SourceApplicationArtifact) []const u8 {
    if (source.source_twelve_level_report_status.len > 0) return source.source_twelve_level_report_status;
...
fn formatPolicyJson(allocator: std.mem.Allocator, options: Options, source: SourceApplicationArtifact, result: PolicyResult, paths: OutputPaths) ![]const u8 {
    ...
    try appendJsonField(allocator, &output, "source_twelve_level_application_boundary", options.application_path, true);
    try appendJsonField(allocator, &output, "source_twelve_level_application_boundary_schema", source.schema, true);
    ...
    try appendJsonField(allocator, &output, "source_twelve_level_after_digest", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_after_digest, true);
    ...
    try output.appendSlice(allocator, "  \"source_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes\": ");
...
fn formatPolicyText(allocator: std.mem.Allocator, options: Options, source: SourceApplicationArtifact, result: PolicyResult, paths: OutputPaths) ![]const u8 {
    ...
    try appendTextList(allocator, &output, "source twelve-level application changes", source.evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_evaluation_report_application_changes);
...
fn usage() []const u8 {
    return "usage: zig build causal-app-facing-twelve-level-policy -- --from-application <twelve-level-application-boundary.json> approve|reject --reason <reason> [--by <actor>] [--policy <policy>] [--verified-command <command>]... [--out-prefix <path-prefix>]\n";
}

fn failUsage(err: anyerror) noreturn {
    std.debug.print("causal-app-facing-twelve-level-policy error: {s}\n{s}", .{ @errorName(err), usage() });
    std.process.exit(2);
}
...
fn readyApplicationBoundaryJson() []const u8 {
    ...
    \\  "schema": "zigeffect.causal.app-facing-production-integration-ci-advisory-remediation-report-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-application-boundary.v1",
    \\  "schema_version": 1,
    \\  "generated_by": "causal-app-facing-twelve-level-application-boundary",
...
test "app-facing advisory remediation report consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report policy schema and branch constants are stable" {
    ...
    try std.testing.expectEqualStrings(
        "start-app-facing-twelve-level-evaluator",
        recommendation,
    );
    try std.testing.expectEqualStrings(
...
test "default output path replaces boundary suffix and compacts long names" {
    const paths = try defaultOutputPaths(
        ...
        ".zig-cache/causal-artifacts/app-facing-ci-twelve-level-application-boundary.json",
    );
    defer paths.deinit(std.testing.allocator);

    try std.testing.expectEqualStrings(
        ".zig-cache/causal-artifacts/app-facing-ci-twelve-level-policy.json",
        paths.json_path,
    );
    try std.testing.expectEqualStrings(
        ".zig-cache/causal-artifacts/app-facing-ci-twelve-level-policy.txt",
        paths.text_path,
    );
...
test "approved and rejected consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report policy output preserve read-only authority" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_application_boundary\": \"source-consumption-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-application-boundary.json\"") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_after_digest\": \"sha256:after-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report-evaluation-report\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, approve_reports.json, "\"source_twelve_level_application_changes\": [\"reviewed local consumption report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report evaluation report application boundary for agents reviewers CI advisory readers and SolidJS webui\"]") != null);
