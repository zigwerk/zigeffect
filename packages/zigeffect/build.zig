...
pub fn build(b: *std.Build) void {
    ...
    const causal_app_facing_thirteen_level_application_boundary_tool_module = b.createModule(.{
        .root_source_file = b.path("tools/causal_app_facing_thirteen_level_application_boundary.zig"),
        .target = target,
        .optimize = optimize,
    });

    const causal_app_facing_thirteen_level_application_boundary_tool = b.addExecutable(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-application-boundary",
        .root_module = causal_app_facing_thirteen_level_application_boundary_tool_module,
    });
    const run_causal_app_facing_thirteen_level_application_boundary_tool = b.addRunArtifact(causal_app_facing_thirteen_level_application_boundary_tool);
    if (b.args) |args| run_causal_app_facing_thirteen_level_application_boundary_tool.addArgs(args);
    const causal_app_facing_thirteen_level_application_boundary_step = b.step("causal-app-facing-thirteen-level-application-boundary", "Record app-facing thirteen-level application boundary evidence");
    causal_app_facing_thirteen_level_application_boundary_step.dependOn(&run_causal_app_facing_thirteen_level_application_boundary_tool.step);

    const causal_app_facing_thirteen_level_application_boundary_tool_tests = b.addTest(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-application-boundary-tests",
        .root_module = causal_app_facing_thirteen_level_application_boundary_tool_module,
    });
    const run_causal_app_facing_thirteen_level_application_boundary_tool_tests = b.addRunArtifact(causal_app_facing_thirteen_level_application_boundary_tool_tests);
    test_step.dependOn(&run_causal_app_facing_thirteen_level_application_boundary_tool_tests.step);

    const causal_app_facing_thirteen_level_policy_tool_module = b.createModule(.{
        .root_source_file = b.path("tools/causal_app_facing_thirteen_level_policy.zig"),
        .target = target,
        .optimize = optimize,
    });

    const causal_app_facing_thirteen_level_policy_tool = b.addExecutable(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-policy",
        .root_module = causal_app_facing_thirteen_level_policy_tool_module,
    });
    const run_causal_app_facing_thirteen_level_policy_tool = b.addRunArtifact(causal_app_facing_thirteen_level_policy_tool);
    if (b.args) |args| run_causal_app_facing_thirteen_level_policy_tool.addArgs(args);
    const causal_app_facing_thirteen_level_policy_step = b.step("causal-app-facing-thirteen-level-policy", "Record app-facing thirteen-level policy evidence");
    causal_app_facing_thirteen_level_policy_step.dependOn(&run_causal_app_facing_thirteen_level_policy_tool.step);

    const causal_app_facing_thirteen_level_policy_tool_tests = b.addTest(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-policy-tests",
        .root_module = causal_app_facing_thirteen_level_policy_tool_module,
    });
    const run_causal_app_facing_thirteen_level_policy_tool_tests = b.addRunArtifact(causal_app_facing_thirteen_level_policy_tool_tests);
    test_step.dependOn(&run_causal_app_facing_thirteen_level_policy_tool_tests.step);

    const causal_app_facing_thirteen_level_evaluator_tool_module = b.createModule(.{
        .root_source_file = b.path("tools/causal_app_facing_thirteen_level_evaluator.zig"),
        .target = target,
        .optimize = optimize,
    });

    const causal_app_facing_thirteen_level_evaluator_tool = b.addExecutable(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-evaluator",
        .root_module = causal_app_facing_thirteen_level_evaluator_tool_module,
    });
    const run_causal_app_facing_thirteen_level_evaluator_tool = b.addRunArtifact(causal_app_facing_thirteen_level_evaluator_tool);
    if (b.args) |args| run_causal_app_facing_thirteen_level_evaluator_tool.addArgs(args);
    const causal_app_facing_thirteen_level_evaluator_step = b.step("causal-app-facing-thirteen-level-evaluator", "Evaluate app-facing thirteen-level policy evidence");
    causal_app_facing_thirteen_level_evaluator_step.dependOn(&run_causal_app_facing_thirteen_level_evaluator_tool.step);

    const causal_app_facing_thirteen_level_evaluator_tool_tests = b.addTest(.{
        .name = "zigeffect-causal-app-facing-thirteen-level-evaluator-tests",
        .root_module = causal_app_facing_thirteen_level_evaluator_tool_module,
    });
    ...
    const causal_app_facing_fourteen_level_application_boundary_tool_module = b.createModule(.{
        .root_source_file = b.path("tools/causal_app_facing_fourteen_level_application_boundary.zig"),
        .target = target,
        .optimize = optimize,
    });

    const causal_app_facing_fourteen_level_application_boundary_tool = b.addExecutable(.{
        .name = "zigeffect-causal-app-facing-fourteen-level-application-boundary",
        .root_module = causal_app_facing_fourteen_level_application_boundary_tool_module,
    });
    const run_causal_app_facing_fourteen_level_application_boundary_tool = b.addRunArtifact(causal_app_facing_fourteen_level_application_boundary_tool);
    if (b.args) |args| run_causal_app_facing_fourteen_level_application_boundary_tool.addArgs(args);
    const causal_app_facing_fourteen_level_application_boundary_step = b.step("causal-app-facing-fourteen-level-application-boundary", "Record app-facing fourteen-level application boundary evidence");
    causal_app_facing_fourteen_level_application_boundary_step.dependOn(&run_causal_app_facing_fourteen_level_application_boundary_tool.step);

    const causal_app_facing_fourteen_level_application_boundary_tool_tests = b.addTest(.{
        .name = "zigeffect-causal-app-facing-fourteen-level-application-boundary-tests",
        .root_module = causal_app_facing_fourteen_level_application_boundary_tool_module,
    });
    const run_causal_app_facing_fourteen_level_application_boundary_tool_tests = b.addRunArtifact(causal_app_facing_fourteen_level_application_boundary_tool_tests);
    test_step.dependOn(&run_causal_app_facing_fourteen_level_application_boundary_tool_tests.step);
