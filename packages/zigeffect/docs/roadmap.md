...
| 15 | Effect-grade standard library | **M1-M13 delivered**: service kernel, production Schema, production Schema-powered CLI, effect-native config/JSON/secrets, streams/queues/pubsub/sinks, local process/workspace/FS adapters, observability recorder/artifacts, HTTP/WebSocket contracts/adapters, SQL contracts plus local Postgres adapter, local agent toolkit, and real local-tool cookbook examples | `packages/zigeffect-std`, `packages/zigeffect-postgres`, `packages/zigeffect-std/docs/cookbook.md`, `docs/superpowers/specs/2026-06-25-zigeffect-std-effectts-grade-roadmap-design.md` |
