...
| 15 | Effect-grade standard library | **M1-M6 delivered; remaining milestones planned**: service kernel, Schema, effect-native config/JSON/secrets, CLI app framework, streams/queues/pubsub/sinks, local process/workspace/FS adapters; next observability, HTTP/WebSocket, SQL/Postgres, agent toolkit | `packages/zigeffect-std`, `docs/superpowers/specs/2026-06-25-zigeffect-std-effectts-grade-roadmap-design.md` |
