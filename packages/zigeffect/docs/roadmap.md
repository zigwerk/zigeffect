...
- The current causal dogfood lane now has local before/after comparison and CI
  handoff artifacts. The next hardening slice is pull request CI baseline
  capture, so failing head artifacts can be compared with base-commit causal
  evidence.
