...
module-pattern requirements listed above. Future work can add an async backend
adapter and a larger application-template catalog without changing the current
