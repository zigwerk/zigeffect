...
| 15 | Effect-grade standard library | **planned in milestones**: service kernel, Schema, effect-native config/JSON/secrets, CLI app framework, streams, local process/workspace/FS adapters, observability, HTTP/WebSocket, SQL/Postgres, agent toolkit | `packages/zigeffect-std`, `docs/superpowers/specs/2026-06-25-zigeffect-std-effectts-grade-roadmap-design.md` |
