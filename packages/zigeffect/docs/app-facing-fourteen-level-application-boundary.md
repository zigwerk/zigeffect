...
`causal-app-facing-fourteen-level-application-boundary` records planned or
reviewed local application-boundary evidence for the fourteen-level app-facing
report.
...
- Tool file: `packages/zigeffect/tools/causal_app_facing_fourteen_level_application_boundary.zig`
- Build step: `causal-app-facing-fourteen-level-application-boundary`
- Executable: `zigeffect-causal-app-facing-fourteen-level-application-boundary`
- Fixture: `packages/zigeffect/test/fixtures/app-facing-fourteen-level-application-boundary-after-safe.txt`
- Current branch: `codex/zigeffect-causal-app-facing-fourteen-level-application-boundary`
- Next branch: `codex/zigeffect-causal-app-facing-fourteen-level-policy`
...
zig build causal-app-facing-fourteen-level-application-boundary -- \
  --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-fourteen-level-report.json \
  plan \
  --reason "planned app-facing fourteen-level application boundary"
```
...
zig build causal-app-facing-fourteen-level-application-boundary -- \
  --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-fourteen-level-report.json \
  record-applied \
  --reason "reviewed app-facing fourteen-level application boundary" \
  --after-report test/fixtures/app-facing-fourteen-level-application-boundary-after-safe.txt \
  --application-change "reviewed local fourteen-level application boundary for agents reviewers CI advisory readers and SolidJS webui" \
  --before "before local fourteen-level application boundary evidence" \
  --after "after local fourteen-level application boundary evidence" \
  --verified-command "bun run zigeffect:workbench:typecheck" \
  --verified-command "bun run zigeffect:workbench:test" \
  --verified-command "zig build causal-app-facing-fourteen-level-report -- --help" \
...
cd packages/zigeffect
zig build causal-app-facing-fourteen-level-application-boundary -- \
  --from-report ../../.zig-cache/causal-artifacts/app-facing-ci-fourteen-level-report-blocked.json \
  record-applied \
  --reason "blocked app-facing fourteen-level application boundary source" \
  --after-report test/fixtures/app-facing-fourteen-level-application-boundary-after-safe.txt \
  --application-change "reviewed local fourteen-level blocked source boundary probe" \
  --before "before local fourteen-level blocked source evidence" \
  --after "after local fourteen-level blocked source evidence" \
  --verified-command "bun run zigeffect:workbench:typecheck" \
  --verified-command "bun run zigeffect:workbench:test" \
  --verified-command "zig build causal-app-facing-fourteen-level-report -- --help" \
  --verified-command "zig build causal-schema-governance -- --format json" \
...
- Direct source fourteen-level report schema and status are recorded.
- Direct source thirteen-level evaluator, policy, application-boundary, report,
