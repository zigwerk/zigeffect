> **SUPERSEDED (2026-06-20).** This master roadmap enumerated a large
> production-hardening / telemetry / app-facing tool surface that was later
> over-generated by an autonomous loop into ~120 record-only clone tools. All of
> those tools were removed. The authoritative forward plan is now
> [packages/zigeffect/docs/roadmap.md](../../../packages/zigeffect/docs/roadmap.md);
> the approved tool surface is [packages/zigeffect/docs/tool-roadmap.md](../../../packages/zigeffect/docs/tool-roadmap.md).
> Tool references below are historical and must NOT be used to recreate tools —
> see the Tool Hygiene Policy in AGENTS.md / CLAUDE.md.
