...
- [x] **Step 3: Implement lifecycle replay**
...
- [x] **Step 1: Write failing resource fold tests**
...
- [x] **Step 3: Implement row folding**
...
- [x] **Step 2: Mark Milestone 3 complete**
...
- [x] Fold rejects malformed histories named in the spec.
- [x] No journal store, parser, workflow engine, activity runner, or schedule math is added.
- [x] Full verification passes before Milestone 3 is marked complete.
