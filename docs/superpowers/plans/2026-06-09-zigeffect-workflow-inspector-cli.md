...
- [x] **Step 1: Write failing build-step tests**
...
- [x] **Step 2: Implement entrypoints**
...
- [x] **Step 4: Verify build steps compile**
...
- [x] **Step 1: Write failing inline CLI tests**
...
- [x] **Step 3: Mark Milestone 18 complete**
