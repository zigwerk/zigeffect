...
- [x] **Step 1: Write failing identity and export tests**
...
- [x] **Step 3: Implement deferred module shell**
...
- [x] **Step 1: Write failing await suspension test**
...
- [x] **Step 3: Implement missing-deferred await**
...
- [x] **Step 1: Write failing completion replay test**
...
- [x] **Step 3: Implement external completion**
...
- [x] **Step 1: Write failing failure and cancellation tests**
...
- [x] **Step 3: Implement failure and cancellation**
...
- [x] **Step 3: Mark Milestone 13 complete**
...
- [x] Awaiting missing deferreds returns a suspension value.
- [x] Completed deferred replay decodes through `Codec`.
- [x] Failed deferred replay returns the requested error-set value.
- [x] Cancelled deferred replay returns the recorded reason.
- [x] External terminal appends are idempotent.
- [x] No distributed notification, scheduler loop, worker polling, or timer integration is added in this milestone.
